...
alert-level-blue-announcement = There is a confirmed threat to the sector. Crews are advised to be vigilant and report suspicious activity to LSRD Rangers.
alert-level-blue-instructions = Crews are advised to be vigilant and report suspicious activity to LSRD Rangers.
...
alert-level-gamma-announcement = Central Command has ordered the Gamma security level in the sector. LSRD Rangers are to be on high alert, and crews are to avoid areas of conflict where possible.
...
# End Frontier
# Changes made by Lonestar, NFSD -> LSRD
