# _CS Start
# region Security
uplink-security-hardsuit-name = Junior Ranger Patrol Suit
...
uplink-security-hardsuit-patrol-name = Ranger Patrol Suit
...
uplink-security-hardsuit-warden-name = LSRD Patrol Suit
...
uplink-security-hardsuit-sheriff-desc = The standard-issue LSRD space proof suit for patrol duty. This gold variant has chief ranger rank markings.
...
uplink-security-hardsuit-commmand-desc = A heavily armored LSRD suit. Space proof, with thick armor plating at the expense of mobility. This variant has command rank markings.
